      ...
      <Container>
        <div className='py-10'>
            <div className='text-center w-[80%] mx-auto space-y-4 text-lg py-3'>
                <h1 data-aos="zoom-in" className='text-4xl uppercase font-bold'>Latest News</h1>
                <p data-aos="zoom-in">
            ...
            <div className='grid grid-cols- md:grid-cols-3 items-center gap-10'>
                {medi.map((item, index)=>(
                    <div key={index} data-aos="zoom-in" data-aos-delay={item.aos} className='border bg-slate-300 border-slate-600 px-3 text-xl py-6 space-y-4' >
