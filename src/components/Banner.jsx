      ...
      <Container>
        <div className=''>
            <div className='grid grid-cols-2 items-center justify-between gap-4 '>
                <div className='text-xl' data-aos="fade-right" data-aos-delay='300'>
                ...
                <div data-aos="fade-left" data-aos-delay='300' className='flex justify-end pt-[20px]'>
                    <img src={image1} alt="" />
                </div>
            </div>
        </div>
      </Container>
      <button data-aos="zoom-in" data-aos-delay='700' className='bg-yellow-400 px-6 text-xl text-white absolute right-[50%] -bottom-[4%] translate-x-20 translate-y-1 py-2'>Find out more </button>
    </div>
  )
}
